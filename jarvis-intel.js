...
(function () {
  ...
  style.textContent = `
    ...
    .intel-var-h{display:flex;align-items:center;gap:8px;font-family:var(--mono);font-size:12.5px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--tt);margin-top:6px}
    ...
    .intel-var-row .vr-d{font-size:12.5px;font-weight:700;min-width:48px;text-align:right}
