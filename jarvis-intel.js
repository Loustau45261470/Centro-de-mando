...
(function () {
  ...
  style.textContent = `
    ...
    .intel-row{display:flex;align-items:flex-start;gap:9px;font-size:var(--fs-13);line-height:1.42;color:var(--ts)}
    .intel-row .ii-ic{flex-shrink:0;font-size:var(--fs-13);width:16px;text-align:center;line-height:1.4}
    ...
    .intel-var-h{display:flex;align-items:center;gap:8px;font-family:var(--mono);font-size:var(--fs-12-5);font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--tt);margin-top:6px}
    .intel-var-h::after{content:'';flex:1;height:1px;background:var(--border)}
    .intel-var-row{display:flex;align-items:center;justify-content:space-between;gap:10px;font-size:var(--fs-13);line-height:1.3}
    ...
    .intel-var-row .vr-d{font-size:var(--fs-12-5);font-weight:700;min-width:48px;text-align:right}
