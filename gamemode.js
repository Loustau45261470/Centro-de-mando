...
const GM_TREE_NODES = [
  ...
  { id: 'manejo_de_armas', name: 'Tirador Novato', icon: '🔫', cat: 'cuerpo', tier: 1, manual: true, requires: {} },
  { id: 'tenencia', name: 'Tirador de Élite', icon: '🔫', cat: 'cuerpo', tier: 1.5, manual: true, requires: { nodes: ['manejo_de_armas'] } },
  { id: 'marine', name: 'Marine', icon: '🎖️', cat: 'cuerpo', tier: 2, manual: true, requires: { nodes: ['tenencia'] } },
  ...
  { id: 'comandante_de_combate', name: 'Comandante de Combate', icon: '🎖️', cat: 'cuerpo', tier: 2, requires: { nodes: ['hombre_de_titanio', 'letal'] } },
  { id: 'cuerpo_operativo', name: 'Cuerpo Operativo', icon: '🦾', cat: 'cuerpo', tier: 2, requires: { nodes: ['impecable', 'inagotable', 'hombre_de_titanio'] } },
  { id: 'mente_templada', name: 'Mente Templada', icon: '🧠', cat: 'mente', tier: 2, requires: { nodes: ['jurista', 'imperturbable', 'inquebrantable'] } },
  { id: 'doctor_en_potencia', name: 'Doctor en Potencia', icon: '🎓', cat: 'mente', tier: 2, requires: { metrics: [{ metric: 'materias', value: 35 }], nodes: ['jurista'] } },
  { id: 'forjador_de_riqueza', name: 'Forjador de Riqueza', icon: '🏦', cat: 'finanzas', tier: 2, requires: { nodes: ['visionario_del_capital', 'patrimonial', 'capital_creciente'] } },
